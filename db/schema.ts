...
export const TRANSACTION_SUBTYPES = ['inflowOutflowDigital', 'inflowOutflowPhysical'] as const;
...
export const transactions = sqliteTable('transactions', {
  ...
  transactionAdditionalDetails: text('transaction_additional_details').notNull(),
