...
import { Badge, ListRow, SectionTitle } from '@/components/ui';
    ...
    <>
      ...
      >
        <View className="p-4">
          ...
          <SectionTitle title="Detected subscriptions" />
                  ...
                  <View className="flex-1 flex-row">
                    ...
                    <View className="flex-1">
                      <View className="mb-2 flex-row items-center gap-2">
                        ...
                        <Badge
                          label={`${getConfidenceBadgeText(sub.confidence)} (${Math.round(sub.confidence * 100)}%)`}
                          variant="neutral"
                          className={getConfidenceColor(sub.confidence)}
